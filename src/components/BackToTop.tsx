...
export function BackToTop() {
    ...
    return (
        <AnimatePresence>
            {isVisible && (
                <div className="fixed right-8 bottom-32 z-[200] pointer-events-none h-[200px] flex items-end justify-center">
                    ...
                    <motion.button
                        ...
                        onClick={scrollToTop}
                        // === CHANGES HERE ===
                        // 1. Added 'p-6' (padding) to make the hit area much bigger.
                        // 2. Added '-m-6' (negative margin) to counteract the padding so it stays centered visually.
                        // 3. Added '!' to cursor classes (!cursor-grab) to force override the spotlight cursor below it.
