...
export function About() {
    ...
    const Content = ({ isRevealLayer }: { isRevealLayer?: boolean }) => (
        <div className="text-left w-full max-w-7xl"> {/* Changed to text-left */}
    ...
    return (
        ...
        >
            ...
            <div className="absolute top-16 md:top-24 left-6 md:left-20 z-40">
                <motion.div
            ...
            <div className="absolute inset-0 flex flex-col justify-center items-start pl-6 md:pl-20 pointer-events-none select-none">
            ...
            <motion.div
                className="absolute inset-0 flex flex-col justify-center items-start pl-6 md:pl-20 pointer-events-none select-none z-10"
                animate={{
                    // We don't move a box anymore. We move the CENTER of the gradient.
            ...
            {/* 4. CUSTOM CURSOR DOT (Small Gradient Ring) */}
            <div className="absolute inset-0 pointer-events-none z-20">
                <motion.div
                    // Reduced size significantly, added soft glow
            ...
            {/* 5. INSTRUCTION HINT - MOVED TO BOTTOM RIGHT */}
